...
const CreateSchedule = () => {
  ...
  return (
    <View style={[styles.container,  darkMode && styles.darkModeContainer]}>
      <Text style={[styles.titles, darkMode && styles.darkModeText]}>Device Name</Text>
      <TextInput
        value={text}
        onChangeText={handleInputChange}
        placeholder="Enter some text here"
        style={[styles.textInput,  darkMode && styles.darkModeContainer]}
      />
 
      {/**turn On time */}
      <Text style={[styles.titles, darkMode && styles.darkModeText]}>When to turn on</Text>
      <TouchableOpacity
        style={styles.button}
      ...
      {/**turn Off time */}
      <Text style={[styles.titles, darkMode && styles.darkModeText]}>When to turn off</Text>
      <TouchableOpacity
        style={styles.button}
      ...
      />
      <Text style={styles.titles [darkMode && styles.darkModeText]}>Select Days</Text>
